...
public class ResponseTradeProxy implements IResponseTrade {
	private DatabaseConnection dbc = null;
	private IResponseTrade dao =null;
	public ResponseTradeProxy() throws Exception {
		this.dbc = new DatabaseConnection();
		this.dao = new ResponseTradeImpl(this.dbc.getConnection());
	}
	@Override
