     ...
     <form action="BackResearch" method="post">
      <ul class="ulColumn2">
       <li>
        ...
        <input name="title" type="text" class="textbox textbox_295" placeholder="题目..."/>  
       ...
       <li>
        ...
        <input name="author" type="text" class="textbox" placeholder="作者..."/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">单位：</span>
        <select name="university" class="select">
         <option value="ustc">中国科大</option>
         <option value="rmu">中国人大</option>
         <option value="xjd">西安交大</option>
       ...
       <input name="date" type="text" class="textbox" placeholder="发文日期..."/>
       ...
       <li>
       <span class="item_name" style="width:120px;">&nbsp&nbsp&nbsp</span>
        <textarea name="content" rows="70" cols="100"></textarea>
       </li>
