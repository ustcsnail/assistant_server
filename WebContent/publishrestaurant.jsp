     ...
     <form action="BackRestaurant" method="post">
      <ul class="ulColumn2">
       <li>
        ...
        <input name="name" type="text" class="textbox textbox_295" placeholder="餐馆名称..."/>  
           
       </li>
       <li>
        <span class="item_name" style="width:120px;">标签：</span>
        <input name="label" type="text" class="textbox" placeholder="餐馆招牌食品..."/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">评分：</span>
        <input name="mark" type="text" class="textbox" placeholder="餐馆星级评分..."/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">均价：</span>
        <input name="price" type="text" class="textbox" placeholder="餐馆消费均价..."/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">等级：</span>
        <select name="level" class="select">
         <option value=1>平价</option>
         <option value=2>优质</option>
         <option value=3>奢侈</option>
        </select>
       </li>
       <li>
       ...
       <input name="district" type="text" class="textbox" placeholder="地标商圈..."/>
      
       </li>
       <li>
        <span class="item_name" style="width:120px;">地址：</span>
        <input name="address" type="text" class="textbox  textbox_295" placeholder="地址..."/>
