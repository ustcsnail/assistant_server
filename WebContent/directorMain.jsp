...
<section class="rt_wrap content mCustomScrollbar">
  ...
  <div class="rt_content">
    ...
    <div class="page_title">
       <h2 class="fl">生活指南列表</h2>
       <a href="publishdirectory.jsp" class="fr top_rt_btn add_icon">添加指南</a>
    </div>
    
    <form action="BackDirectory"  method="get">
       <section class="mtb">
                              指南类型：&nbsp
           <select name="type" class="select">
              <option value="gov" >  办事指南  </option>
              <option value="life" >  生活指南  </option>
    ...
    <table class="table">
       <tr>
        ...
        <th>操作</th>
              ...
              <%List<Director> list=(List<Director>)request.getAttribute("list"); %>
              <%if(list!=null) {%>
            	  <%for(Director e:list){%>
            	   <tr>
                     <td class="center"><%=e.getId() %></td>
                     <td class="center"><%=e.getTitle() %></td>
                     <td class="center"><%=e.getContent()%></td>
                     <td class="center">
                     <a href="BackDirectory?id=<%=e.getId()%>&operate=modify" title="编辑" class="link_icon">&#101;</a>
                     <a href="BackDirectory?id=<%=e.getId()%>&operate=delete" title="删除" class="link_icon">&#100;</a>
                  </td>
                  </tr>
                  <% }%>
              <%}%>
